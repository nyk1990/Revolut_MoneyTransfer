...
public class TestAccountDAO {
	...
	public void testGetAllAccounts() throws CustomException {
		List<Account> allAccounts = h2DaoFactory.getAccountDAO().getAccounts();
	...
	public void testUpdateAccountBalanceSufficientFund() throws CustomException {
		...
		int rowsUpdated = h2DaoFactory.getAccountDAO().updateBalance(1L, deltaDeposit);
		...
		int rowsUpdatedW = h2DaoFactory.getAccountDAO().updateBalance(1L, deltaWithDraw);
