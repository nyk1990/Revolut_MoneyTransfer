...
public class TestUserDAO {
	...
	private static final DAO h2DaoFactory = DAO.getDAO(DAO.H2);
	...
	public void testGetAllUsers() throws CustomException {
		List<User> allUsers = h2DaoFactory.getUserDAO().getUsers();
	...
	public void testGetUserById() throws CustomException {
		...
		assertTrue(u.getUserName().equals("mary"));
	}
	...
	public void testGetNonExistingUserByName() throws CustomException {
		User u = h2DaoFactory.getUserDAO().getUserByName("abc");
		assertTrue(u == null);
	}
	...
	public void testCreateUser() throws CustomException {
		...
		assertTrue(uAfterInsert.getUserName().equals("john"));
		assertTrue(u.getEmailAddress().equals("john@gmail.com"));
	}

	@Test
	public void testUpdateUser() throws CustomException {
		User u = new User(1L, "mary", "mary@gmail.com");
		int rowCount = h2DaoFactory.getUserDAO().updateUser(1L, u);
		// assert one row(user) updated
		assertTrue(rowCount == 1);
		assertTrue(h2DaoFactory.getUserDAO().getUserById(1L).getEmailAddress().equals("mary@gmail.com"));
	}
