...
public class TestUserService extends TestService {
   ...
   /* @Test
    public void testGetUser() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/user/mary").build();
        ...
        assertTrue(user.getEmailAddress().equals("mary@gmail.com"));
    ...
    public void testCreateUser() throws IOException, URISyntaxException {
        ...
        assertTrue(uAfterCreation.getUserName().equals("sam"));
        assertTrue(uAfterCreation.getEmailAddress().equals("sam@gmail.com"));
    }
    ...
    */
    ...
    public void testUpdateUser() throws IOException, URISyntaxException {
        ...
        User user = new User(2L, "john", "john123@gmail.com");
        String jsonInString = mapper.writeValueAsString(user);
        StringEntity entity = new StringEntity(jsonInString);
